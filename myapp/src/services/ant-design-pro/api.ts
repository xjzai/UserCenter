...
export async function currentUser(options?: { [key: string]: any }) {
  return request<API.BaseResponse<API.CurrentUser>>('/api/user/userinfo', {
    method: 'GET',
    ...(options || {}),
  });
}
...
/** 登录接口 POST /api/user/update */
export async function update(body: API.CurrentUser, options?: { [key: string]: any }) {
